...
option.statuscolumn = [[%!v:lua.require'utils.statuscol'.statuscolumn()]]
option.textwidth = 80
...
if vim.fn.has("nvim-0.10") == 1 then
  ...
  option.foldexpr = "v:lua.require'utils.statuscol'.foldexpr()"
  option.foldmethod = "expr"
  option.foldtext = ""
else
  option.foldmethod = "indent"
  option.foldtext = "v:lua.require'utils.statuscol'.foldtext()"
end
