...
-- 	group = augroup("arrase_Highlights"),
-- 	pattern = "*",
-- 	callback = function()
-- 		local highlighter = vim.api.nvim_set_hl
-- 		Theme = require("solarized-osaka.colors")
...
-- 		HL("CmpBorder", Theme.default.terminal_black, Theme.bg, true)
-- 		HL("CmpBorderDoc", Theme.default.terminal_black, Theme.bg, true)
-- 		HL("CmpBorderIconsLT", Colors.blue["400"], Theme.bg)
-- 		HL("CmpBorderIconsCT", Colors.orange["500"], Theme.bg)
-- 		HL("CmpBorderIconsRT", Colors.green["300"], Theme.bg)
-- 		HL("CmpNormal", Colors.purple["500"], Theme.bg)
-- 		HL("CmpItemMenu", Colors.blue["400"], Theme.default.bg_dark)
-- 		-- HL("CmpGhost", Colors.blue["400"], Theme.default.bg_dark)
--
-- 		--[[
-- -- Telescope
-- --]]
-- 		HL("TelescopeNormal", Colors.blue["200"], Theme.bg)
-- 		HL("TelescopeBorder", Theme.default.bg_dark, trans)
-- 		HL("TelescopePromptNormal", Colors.orange["500"], Theme.bg)
-- 		HL("TelescopePromptBorder", Theme.default.bg_dark, Theme.bg)
-- 		HL("TelescopePromptTitle", Colors.blue["200"], Theme.bg)
...
-- 		HL("FloatBorder", Colors.purple["500"], Theme.bg)
-- 		HL("Ghost", Colors.blue["200"], trans)
--
...
-- local selectedTheme = "catppuccin-macchiato"
vim.api.nvim_create_autocmd({ "ColorScheme", "ColorSchemePre" }, {
